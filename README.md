...
Форма запуска работника спрашивает только своё — сколько дней играть.
Служебные поля Airflow в ней — «Logical date» и «Run ID» за створкой
«Advanced Options» — к оси мира отношения не имеют: какой день пойдёт первым,
смотрите в `world_position`, а какой сыгран — в журнале шага
`remember_played`.
