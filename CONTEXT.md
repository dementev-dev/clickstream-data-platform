...
**Опись мира**:
`data/world-inventory.json` — паспорт и контрольные отметки неизменяемого
выхода мира: хеши дней событий и отправленных слепков, счётчики закрытых
окон с названным читателем. Сам мир пересчитывается; опись отвечает на один
вопрос: тот ли это мир.
