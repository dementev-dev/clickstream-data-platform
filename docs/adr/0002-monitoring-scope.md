...
человеческих.
Отдельная панель ошибок понадобилась под здешний же сюжет про тяжёлый
`GROUP BY`: отказ по памяти случается на шарде, и текст ошибки — единственное
место, где написано, на каком. Устройство обоих дашбордов —
