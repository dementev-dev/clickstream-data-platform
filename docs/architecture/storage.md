...
| `45-dds-tables.sql` | физические модели заказа и сессии, доноры их партиций |
| `50-dds-views.sql` | публичные договоры события, заказа и сессии на языке модели DDS |
...
карта пишет полный набор пар в версионную таблицу. Слой DM принесут следующие
тикеты этапа. Его состав задан разделом 7 мастер-спеки и переносится сюда по
мере постройки.
