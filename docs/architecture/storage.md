...
публичным договором события `dds.event_v` над точным состоянием ODS.
...
| `50-dds-views.sql` | публичный договор события на языке модели DDS |
...
Слой DDS начат представлением `dds.event_v`; остальные его сущности и слой DM
появятся в следующих тикетах этапа. Их состав задан разделом 7 мастер-спеки и
переносится сюда по мере постройки.
