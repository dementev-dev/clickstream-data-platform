...
В слое DDS построены событие, заказ и сессия, и устроены они намеренно
по-разному: событие остаётся представлением над ODS, у заказа и сессии —
физические модели. Карту идентичностей и слой DM принесут следующие тикеты
этапа. Их состав задан разделом 7 мастер-спеки и переносится сюда по мере
постройки.
