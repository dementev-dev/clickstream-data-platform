...
`make smoke` и `make check-services` перемерены 21 августа 2026 года,
`make check-clickhouse` — 19 августа, корневой `make lint` — 9 августа,
`make test` — 7 августа; остальные стоят с замера 6 августа.
