...
печатает идентификаторы дага и прогона и возвращает вызывающему его итог.
Ожидание доставки событий и запуск `orders_ingest` теперь видны задачами
`world_initialize`, а не спрятаны в shell.
