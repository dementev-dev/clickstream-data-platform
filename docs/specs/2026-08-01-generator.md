...
- **Состав не замкнут: посетители появляются и уходят.** План состава задаёт
  календарь появления — у каждого посетителя есть дата первого визита и
  профиль возвратов, заметная доля кук одноразовая, как в живом трафике.
  Новые посетители появляются на всём протяжении оси: uniq(ClientID) растёт
  с горизонтом, DAU и MAU не сходятся в одно число. Приток — часть плана, а
  не мутация: счётчики манифеста по-прежнему известны до генерации
  (уточнение по вычитке владельца, 2026-08-01).
