...
- **Границы правки — те же вилки раздела 5**: аудитория 6–8 тыс., средний
  день около 50 тыс. событий (сейчас 49 509 — запас невелик, и рост
  событий корзины считается против него), конверсия визита около 2%
  (сейчас 2,43%). Заказ рисуется из корзины, а корзина сузилась, поэтому
  доля брошенных позиций (число мира — 15%, замер по покупающим корзинам —
  12%) и состав заказа (1,87 позиции) перемеряются вместе с
