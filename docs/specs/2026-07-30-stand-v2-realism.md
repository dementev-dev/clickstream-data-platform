...
- неатомарное обновление словаря на кластере: ноды перезагружают его в
  ...
  правки каталога две ноды отвечают на один `dictGet` по-разному — почти всё
  окно целиком. Обвязка готова ([ADR
  0012](../adr/0012-dictionary-home.md)), урок остаётся на выбор;
