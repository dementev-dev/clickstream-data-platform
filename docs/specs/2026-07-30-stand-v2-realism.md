...
- заказная сторона: счётчики наблюдаемых классов расхождений после
  ...
  закрытым окном (самопроверка лабы сверки; при N сыгранных днях таких дней
  N − 7). Отдельных полей для общего числа заказов и выручки в описи пока
  нет: для них не назван читатель;
