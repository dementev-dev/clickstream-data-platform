...
запускать»: стенд собирается с нуля и на нём зелены все три цели, которым
нужен стенд. Это гигиена, а не приёмка: она обещает, что этап не сломал стенд,
и молчит о его предмете — дашборд может быть не нарисован, а все три останутся
