...
ориентир ~10%. Точные доли зафиксированы замером на каноническом мире
(28 дней, 2026-08-30, #194) — запись в «Что проверено»
[карты проверок](../architecture/testing.md); опись хранит счётчики наблюдаемых классов после приоритета — в заказах и
...
- Лабы и курс: v2 — другой стенд, лабы для него пишутся с нуля отдельной
  ...
  конвейер, в который она встает, проектируются вместе. Сюда же —
  необязательная лаба «свой дашборд в Superset» (#197): она стоит на
  витринах домашек DM и продумана до готового ТЗ в этапе 8, тогда как
  остальные лабы пока на уровне идей. Единый стиль блока
