...
- Имена файлов в `docs/formats/` — слаг строчными латинскими буквами через
  ...
  пишется руками.
- Имена файлов в `docs/labs/` — `S-N-slug.md`: номер ступени, номер задания
  внутри ступени и слаг строчными латинскими буквами через дефис
  (`1-2-top-pages-daily.md`), индекс папки — `README.md`. Здесь живут ТЗ
  ...
  Факультативы порядка не имеют и живут под одним слагом
  (`superset-dashboard.md`).
