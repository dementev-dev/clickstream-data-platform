...
- Имена файлов в `docs/formats/` — слаг строчными латинскими буквами через
  ...
  пишется руками.
- Имена файлов в `docs/labs/` — слаг строчными латинскими буквами через дефис
  (`top-pages-daily.md`), индекс папки — `README.md`. Здесь живут ТЗ учебных
  заданий. Ни даты, ни номера: задание — не событие истории, а живой документ,
  и правится он вместе с тем, о чем говорит. Слаг называет предмет задания.
