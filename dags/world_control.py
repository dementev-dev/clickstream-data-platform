    ...
    params={
        "days": Param(
            ...
            description_md=(
                ...
                "дня шаговый даг берёт из переменной `world_position` (Admin → "
...
def world_next_day():
    ...
    день шаговый даг берёт из `world_position`. Логическая дата прогона на выбор
    дня не влияет.
    """
...
def world_live_day():
    ...
    Следующий день шаговый даг берёт из `world_position`. Логическая дата прогона
