...
Заказы и сессии собираются в донор, затем публикуются заменой дневных партиций.
Карта идентичностей пересчитывается целиком после заказов и записывается новой
версией; публичное представление выбирает текущие строки через FINAL.
