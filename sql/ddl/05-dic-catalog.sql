...
-- источнику, и цена у неё заявленная — ноды обновляются вразнобой. Ждать
-- правки каталога каждой из них приходится от нуля до верхней границы окна,
-- фазы у них независимы, поэтому расходиться они могут почти на все
-- полторы минуты: одна перезагрузилась сразу после правки, вторая ещё нет.
--
