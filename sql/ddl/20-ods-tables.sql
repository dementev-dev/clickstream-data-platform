...
--
-- У STG ключ другой (хеш строки), поэтому сырая строка и разобранное из неё
...
-- координатам доставки. Нарезка по дню загрузки, как у STG: модельного дня
-- у брака тоже нет.
--
-- Срок жизни — месяц, вдесятеро дольше сырых данных. Истеки брак вместе с ними —
