...
# отправка пары «просмотр подтверждения + purchase». Числа черновые:
# точная калибровка будет при пересборке эталонного мира, этап 7.
...
# выходит либо оплаченным, либо отменённым. Доли черновые: калибровка —
# пересборка эталонного мира, этап 7.
ORDER_OUTCOME_WEIGHTS = (
    95,  # оплачен
    3,  # оплачен, потом отменён
    2,  # отменён неоплаченным
)
...
# профиль гаснет, поэтому обрыв окна в данных не виден. Веса черновые, как и
# доли исходов.
...
# выходит вдвое-втрое ниже броска, около ориентира мастер-спеки в 1–2%. Число
# черновое: калибровка — пересборка эталонного мира, этап 7.
...
# появился в стартовом мире. Числа черновые: калибровка — этап 7.
